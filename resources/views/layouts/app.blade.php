...
<body>
    ...
    <div class="container col-xs-12 col-sm-12 col-lg-12 col-md-12 text-center" style="padding-top:120px;padding-bottom:30px;">
        <div style="padding:30px;margin:0px; background-color: white;">
