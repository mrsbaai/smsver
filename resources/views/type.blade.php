...
<br/><br/><br/>
	...
	<div class="card-body">
      ...
      <a href="/ethereum" class="btn btn-lg paybutton eth"><span><i class="fab fa-ethereum"></i> Ethereum </span></a>
      <a href="/bitcoin" class="btn btn-lg paybutton bitcoin"><span><i class="fab fa-btc"></i> Bitcoin </span></a>
      
      <br/><br/>
      <h4><span class="label label-danger">Limited time offer: Use promo code "crypto-forever-335" to get %10 OFF</span></h4>
