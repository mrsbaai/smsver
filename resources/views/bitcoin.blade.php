            ...
            <div class="row align-items-center" >
                <div class="container col-xs-12 col-sm-12 col-md-12 col-lg-10" >
                    ...
                    <div class="jumbotron" style="padding:20px; background-color: #ced4d8; color:black;" >
                        <p>Please transfer the exact amount of <strong>{{$btc}} BTC</strong> to the BTC address shown on this page in one transaction.</p>
                        <div class="row align-items-end" >
                            <div class="col-4 text-left" >
                                {!!QrCode::size(250)->generate('bitcoin:'. $address . '?amount=' . $btc)!!}
                            </div>
