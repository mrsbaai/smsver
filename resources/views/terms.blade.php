...
@section('content')
    ...
    <div class="container marketing col-sm-12">
        <ul style="line-height: 35px;">
            <li>Screen scraping is not permitted. If you need automated access to our data, please register and use the api service. </li>
            <li>By accepting this agreement you also indemnify and hold harmless corban works, its employees, agents, officers, affiliates, and host from any claims, costs, damages, or expenses resulting from injury, damage, loss, or legal action that may result from the use of the provided information. </li>
            <li>By accepting this agreement you acknowledge that the information provided is randomly generated, and should be considered fictional. Any similarities between generated identities and actual person(s) is completely coincidental. </li>
            <li>Bou agree to be bound by our license agreement. </li>
            <li>Customers may place as many  orders as they want, but are only allowed to have three (3) free orders in the queue at a time. </li>
